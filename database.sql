...
-- Query 1: Show all fault reports with equipment name
SELECT 
...
-- Query 2: Show all service tickets and assigned technicians
SELECT 
...
-- Query 3: Show all service actions for each service ticket
SELECT 
    service_ticket.ticket_id,
...
-- Query 4: Show equipment with the highest number of fault reports
SELECT 
    equipment.name,
...
-- Query 5: Show how many service tickets each technician handles
SELECT 
    technician.first_name,
    technician.last_name,
